...
export class SidePanel {
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (SidePanel.currentPanel) {
      SidePanel.currentPanel._panel.reveal(column);
      SidePanel.currentPanel._update();
      return;
    }
    ...
    SidePanel.currentPanel = new SidePanel(panel, extensionUri);
  }

  public static kill() {
    SidePanel.currentPanel?.dispose();
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "dist/compiled", "HelloWorld.js")
    );
